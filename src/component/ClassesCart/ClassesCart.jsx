        ...
        <div className="card w-96 bg-base-100 shadow-xl text-black">
            ...
            <div className="card-body ">
                ...
                <div className="card-actions flex justify-end">
                    <button onClick={ handleSelectedCourse} className="btn bg-blue-700 border-blue-500 border-2 border-r-0 border-t-0 hover:scale-125 hover:bg-blue-600 text-white font-semibold">Select Course</button>
                </div>
            </div>
        </div>
    );
